...
func completionSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "completion.sh", size: 2359, mode: os.FileMode(436), modTime: time.Unix(1545141835, 0)}
