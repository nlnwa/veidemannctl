...
var Assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 12, 16, 9, 40, 17, 610463497, time.UTC),
		},
		"/CrawlExecutionStatus_table.template": &vfsgen۰CompressedFileInfo{
			name:             "CrawlExecutionStatus_table.template",
			modTime:          time.Date(2019, 12, 13, 14, 44, 17, 350032183, time.UTC),
		...
		"/CrawlLog_table.template": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 12, 13, 14, 44, 17, 351032189, time.UTC),
		...
		"/PageLog_table.template": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 12, 13, 14, 44, 17, 352032194, time.UTC),
		...
		"/collection_table.template": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 12, 13, 14, 44, 17, 353032200, time.UTC),
			uncompressedSize: 154,
		...
		"/crawlEntity_table.template": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 12, 16, 8, 42, 33, 509055516, time.UTC),
		...
		"/crawlEntity_wide.template": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 12, 16, 8, 42, 33, 515055549, time.UTC),
		...
		"/crawlHostGroupConfig_wide.template": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 12, 13, 14, 44, 17, 354032205, time.UTC),
			uncompressedSize: 154,
		...
		"/json.template": &vfsgen۰FileInfo{
			name:    "json.template",
			modTime: time.Date(2019, 11, 1, 8, 43, 30, 491971887, time.UTC),
		...
		"/roleMapping_table.template": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 12, 13, 14, 44, 17, 355032211, time.UTC),
		...
		"/seed_table.template": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 12, 13, 18, 7, 5, 473199969, time.UTC),
			uncompressedSize: 207,
		...
		"/seed_wide.template": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 12, 16, 9, 40, 17, 605463472, time.UTC),
