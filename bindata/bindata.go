...
var Assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/crawllog.template": &vfsgen۰CompressedFileInfo{
			name:             "crawllog.template",
			modTime:          time.Date(2019, 11, 1, 8, 0, 58, 615486587, time.UTC),
			uncompressedSize: 984,
		...
		"/jobexecution.template": &vfsgen۰CompressedFileInfo{
			name:             "jobexecution.template",
			modTime:          time.Date(2019, 10, 30, 14, 57, 19, 471490855, time.UTC),
		...
		"/pagelog.template": &vfsgen۰CompressedFileInfo{
			name:             "pagelog.template",
			modTime:          time.Date(2019, 10, 30, 14, 57, 19, 472490860, time.UTC),
		...
		"/screenshot.template": &vfsgen۰CompressedFileInfo{
	...
	fs["/"].(*vfsgen۰DirInfo).entries = []os.FileInfo{
		...
		fs["/crawlexecution.template"].(os.FileInfo),
		fs["/crawllog.template"].(os.FileInfo),
		fs["/jobexecution.template"].(os.FileInfo),
		fs["/json.template"].(os.FileInfo),
		fs["/pagelog.template"].(os.FileInfo),
		fs["/screenshot.template"].(os.FileInfo),
	}
